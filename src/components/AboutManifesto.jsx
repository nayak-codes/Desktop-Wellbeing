...
export default function AboutManifesto({ onToast }) {
  return (
    <section className="section-padding bg-[#060911] border-t border-white/10 relative overflow-hidden">
      <div className="container mx-auto px-6">

        {/* Main CTA Card */}
        <div className="max-w-5xl mx-auto rounded-3xl bg-gradient-to-b from-blue-950/40 to-[#0a101f] border border-blue-500/25 p-8 sm:p-14 text-center shadow-2xl relative overflow-hidden">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/25 text-blue-400 text-xs font-semibold mb-5 mx-auto">
            <img src="/logo.png" alt="Logo" className="w-3.5 h-3.5 rounded object-cover" />
            <span>Open Source & Free • MIT License</span>
          </div>
          ...
          <p className="text-base sm:text-lg text-slate-300 max-w-2xl mx-auto leading-relaxed mb-10">
            Download Desktop Wellbeing today. Track your screen time, build healthy digital habits, and reclaim deep focus on Windows 10 & 11.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            >
              <WindowsModernIcon className="w-5 h-5 text-white" />
              <span>Download for Windows ({RELEASE_VERSION})</span>
            </a>
